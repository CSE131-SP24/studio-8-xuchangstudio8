...
public class SelectAllQuestion extends MultipleChoiceQuestion {
	...
	public int checkAnswer(String givenAnswer) {
		...
		int pointsOff = this.findMissingCorrectAnswers(givenAnswer) + this.findIncorrectGivenAnswers(givenAnswer);
		if (pointsOff < this.getPoints()) {
			return this.getPoints() - pointsOff;
		}
		else{
			return 0;		
		}
